...
class CourseClass:
    ...
    #Categories of Courses
        courseName = Label(self.root,text="Course Name",font=("times new roman",15,"bold"),bg="white").place(x=10,y=60)
        duration = Label(self.root,text="Duration",font=("times new roman",15,"bold"),bg="white").place(x=10,y=100)
        charges = Label(self.root,text="Charges",font=("times new roman",15,"bold"),bg="white").place(x=10,y=140)
        description = Label(self.root,text="Description",font=("times new roman",15,"bold"),bg="white").place(x=10,y=180)
