...
class StudentClass :
    def __init__(self,root):
        ...
        self.txt_year=ttk.Combobox(self.root,textvariable= self.var_course,values=("Select","1st Year","2nd Year","3rd Year","4th Year"),font=("goudy old style",15,"bold"),state='readonly',justify=CENTER)
